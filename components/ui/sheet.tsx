...
// 👇 свой тип, чтобы можно было передавать className
  ...
  'fixed z-50 gap-4 bg-background p-6 shadow-lg border',
  {
    variants: {
      side: {
        ...
        left:
          'inset-y-0 left-0 h-full w-3/4 border-r data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm',
        right:
